...
Ece'nin üzerindeki Paket 2 (süreç/board/test) Görkem tarafından devralındı; Paket 5'in kalan
işleri Bahar'a geçti. Durum akademiye Scrum Master tarafından bildirilecektir.

## Tahmin Edilen ve Gerçekleşen Puan

Sprint 2 planı **64 puandı**; **56 puan tamamlandı**, 8 puan Sprint 3'e taşındı.
...
| C2 — Soru sorma mobil UX turu | 3 | ➡️ Sprint 3'e taşındı |
| C3 — Pano cilası (matematik neti ayrı seri) | 5 | ➡️ Sprint 3'e taşındı |

**Taşıma gerekçesi:** C2/C3, ayrılan üyenin sahipsiz kalan paketindeydi; kapasite diğer
paketlerin tamamlanmasına harcandı. Sprint 3 planına ilk sıradan girecekler.
...
- [ ] Ece'nin ayrılışının akademiye bildirilmesi (SM)
- [ ] C2/C3 Sprint 3 planına ilk öncelik olarak alınacak
